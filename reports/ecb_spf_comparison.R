...
#setwd("/Users/benoitgoye/Desktop/reports/figures")
...
# Color scheme
forecast_color <- "#69A3D1"  # Blue color matching the attached figure
...
ggsave("combined_forecast_panels.png", plot = p4, width = 12, height = 10, dpi = 300, bg = "white")
