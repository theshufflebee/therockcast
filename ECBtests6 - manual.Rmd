...
worker_results <- foreach(
  ...
  inflation_arma <- my.auto.arima(training$inflation_gap, max.p=4, max.q=4, max.d=1)
  #exp_inflation_arma <- my.auto.arima(training$exp_inflation_gap, max.p=4, max.q=4, max.d=1)
  outputgap_arma <- my.auto.arima(training$output_gap, max.p=4, max.q=4, max.d=0)
  interest_arma <- my.auto.arima(training$rate, max.p=4, max.q=4, max.d=1) # Benchmark
...
our_predict <- function(data,formula,H){
  ...
  # --- 1. Fit inputs and benchmark models  ---
   inflation_arma <- my.auto.arima(data$inflation_gap, max.p=4, max.q=4, max.d=1)
   #exp_inflation_arma <- my.auto.arima(data$exp_inflation_gap, max.p=4, max.q=4, max.d=1)
   outputgap_arma <- my.auto.arima(data$output_gap, max.p=4, max.q=4, max.d=0)
   interest_arma <- my.auto.arima(data$rate, max.p=4, max.q=4, max.d=1) # Benchmark
