...
source(here("auto_ARIMA_replic_fix.R"))
...
worker_results <- foreach(
  ...
  outputgap_arma <- my.auto.arima(training$output_gap, max.p=4, max.q=4, max.d=1)
...
our_predict <- function(data,formula,H){
  ...
  # --- 1. Fit inputs and benchmark models  ---
   ...
   outputgap_arma <- my.auto.arima(data$output_gap, max.p=4, max.q=4, max.d=1)
