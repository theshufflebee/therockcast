...
We find that the models based on the Taylor Rule formula without lags have heavily auto correlated errors significant at the 1% level, while the ones with lagged inflation exhibit autocorrelation to a lesser degree. For our model 3 we reject $H_0$ at only the 5\% significance level, while model 4 exhibits no autocorrelation in the horizon 1 errors.
