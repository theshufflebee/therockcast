...
\end{aligned}
$$
Where $x = \{ \tilde{\pi}_t , \tilde{y}_t , i_t \}$ (for the benchmark). We thus prove that our forecasts using the ARMA models are optimal. We then apply this using the Taylor Rule formula above to prove that this implies our model forecasts the interest rate optimally.
