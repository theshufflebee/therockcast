...
ggplot(data, aes(x = date, color = series)) +
  ...
  geom_line(aes(y = output_gap, color = "Output Gap (HP)"), linewidth = 1) +
...
```{r ham, warning=FALSE, message=FALSE}

#in order to use Hamilton filter for the rest of the code (enable or disable)
