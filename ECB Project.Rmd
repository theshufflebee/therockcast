...
kable(all_stationarity_results, digits = 4, format = format, booktabs = TRUE, 
      ...
      save_kable("figures/staionarity_results.png")
...
kable(coint_test, digits = 4, format = format, booktabs = TRUE,
      ...
      position = "center") %>%
        column_spec(1, border_right = TRUE) %>%
      save_kable("figures/cointegration_results.png")
...
kable(chow_df, digits = 4, format = format, booktabs = TRUE,
      ...
      position = "center") %>%
        column_spec(1, border_right = TRUE) %>%
      save_kable("figures/chow_breaks.png")
...
kable(bp_df, format = format, booktabs=TRUE,
  ...
  kable_styling(latex_options = "scale_down",
      position = "center") %>%
      save_kable("figures/bp_breaks.png")
...
ggsave(filename = "roll_coef_rate_plot.png", path = "figures/")
plot_rolling_coefs(TR_roll, "inflation_gap", var_name_title="Inflation (Gap)")
ggsave(filename = "roll_coef_inflation_plot.png", path = "figures/")
plot_rolling_coefs(TR_roll, "output_gap", var_name_title="Output Gap")
ggsave(filename = "roll_coef_output_plot.png", path = "figures/")
...
generate_mincer_zarnowitz_report <- function(F_model, 
  ...
  table_output <- kable(
    ...
    footnote(
      ...
      threeparttable = TRUE) %>%
      save_kable(paste("figures/", model_caption, ".png", sep=""))
  return(table_output) }
...
ggplot(eval_all_models, aes(x = date_of_forecast, y = .data[[model]], group = period, color = factor(period))) +
  ...
  theme(plot.title = element_text(face = "bold", size = 14, margin = margin(b=5)),
      ...
      axis.title = element_text(size = 12),
      axis.text = element_text(size = 10))
ggsave(filename = "spaghetti_plot.png", path = "figures/")
...
ggplot(eval_all_models, aes(x = date_of_forecast, group = period)) +
  ...
  theme(plot.title = element_text(face = "bold", size = 14, margin = margin(b=5)),
      ...
      axis.title = element_text(size = 12),
      axis.text = element_text(size = 10))
ggsave(filename = "spaghetti_errors_plot.png", path = "figures/")
...
ggsave(filename = "FE_var_plot.png", path = "figures/") 
...
display_forecasts <- function(forecast_list, 
  ...
  column_spec(1, bold = TRUE, border_right = TRUE)
    return(table_output) %>%
      save_kable(paste("figures/", caption, ".png", sep=""))}
...
ggsave(filename = "actual_forecasts_plot.png", path = "figures/") 
...
ggplot(final_interval, aes(x = seq_len(nrow(final_interval)), y = TR_Forecast, group = 1)) +
  ...
  theme(plot.title = element_text(face = "bold", size = 14, margin = margin(b=5)),
      ...
      axis.text = element_text(size = 10),
      axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(filename = "actual_forecast_intervals_plot.png", path = "figures/") 
