...
our_predict <- function(data,formula,H){
  ...
  return(list(TR_Forecast = TR_preds, 
                ...
                inflation_gap_arma = inflation_arma,
                output_gap_arma = outputgap_arma,
                benchmark_arma = interest_arma))}
...
final_fc_plot2
if (save_figures) {
  ggsave(filename = "actual_forecast_intervals_plot.png", path = "figures/", plot=final_fc_plot2)} 
