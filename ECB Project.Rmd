...
# Cleanup
rm(all_stationarity_results, coint_test, test_inflation, test_inflation_diff,
   test_output_gap, test_rate, test_rate_diff)
...
# Add a row where lowest quarter -0.25 and add for all lower and upper sd = 0 and add last(data) as the Value
