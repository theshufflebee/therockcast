...
source(here("scripts/raw_data_plot.R"))
...
source(here("scripts/data_properties.R"))
...
source(here("scripts/taylor_estim_no_lag.R"))
...
#paste first half of this script
source(here("scripts/taylor_estim_with_lag.R"))
...
#paste only seventh
source(here("scripts/pseudo_outofsample_results_script.R"))
...
#do paste without pred int part
source(here("helpers/final_forecast_script.R"))
