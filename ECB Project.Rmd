...
# BIG NOTE: THIS FILE IS CURRENTLY BROKEN, AND ONLY SERVES AS AN OUTLINE TO LATER IMPLEMENT THE CODING APPENDIX. JUST PASTE THE PARTS OF THE SCRIPTS COMMENTED IN THE CHUNKS ONCE ALL CODE IS FINALISED.
...
```{r dm_test_func, echo=TRUE, message=FALSE, warning=FALSE}
